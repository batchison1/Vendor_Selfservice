...
const TILES: { title: string; desc: string; tab: string; bg: string; fg: string; icon: string }[] = [
  ...
  { title: "Contacts", desc: "Primary, AP and sales contacts", tab: "contacts", bg: "#EEF3FA", fg: "var(--color-navy)", icon: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" },
  ...
  { title: "Banking & remittance", desc: "EFT / ACH payment details", tab: "banking", bg: "#FFF4CC", fg: "#8A6D00", icon: "M3 10 12 4l9 6M4 10v8M20 10v8M8 10v8M16 10v8M3 21h18" },
  { title: "Tax & W-9", desc: "TIN, classification, W-9 form", tab: "tax", bg: "#EEF3FA", fg: "var(--color-navy)", icon: "M9 2h6a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zM10 7h4M10 11h4M10 15h2" },
  { title: "Documents & compliance", desc: "W-9, COI, licenses, certs", tab: "documents", bg: "#FDECDD", fg: "var(--color-orange)", icon: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6" },
...
export function VendorConsole() {
  ...
  return (
    <AppShell title="My dashboard" crumb="Vendor Portal">
      <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "18px 22px", borderRadius: 10, background: "linear-gradient(120deg,#0C2F50,#17516B)", color: "#fff", marginBottom: 22 }}>
        <div style={{ flex: 1 }}>
